...
public record StudySessionListResponse(
        ...
        @Schema(
                description =
                        "조회 범위 내 최장집중시간(초) — 세션 하나 안에서 이벤트(PHONE/DEVICE/AWAY/SLEEP/PAUSE)로 끊기지 않고 이어진 가장 긴 구간을 세션마다 구해, 그중 최댓값. 세션이 없으면 0",
                example = "3000")
        ...
        @Schema(
                ...
                example = "{\"PHONE\": 3, \"DEVICE\": 0, \"AWAY\": 1, \"SLEEP\": 2, \"PAUSE\": 1}")
